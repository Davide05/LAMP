     ...
     <xsl:template match = "/" >  
          <table border = "1" style="color:blue;font-size:40px" >
               <tr >
                    ...
                    <td> <xsl:value-of select = "/maestri/musicisti"/> </td> 
               </tr>  
               <tr > 
                    <td> <xsl:text>Seconda Query: estrae tutte le opere d'arte </xsl:text> </td>
                    <td> <xsl:value-of select = "/*" /> </td>
               </tr>
               <tr > 
                    <td> <xsl:text>Terza Query: estrae seconda di Giacomo Puccini </xsl:text> </td>
                    <td> <xsl:value-of select = "/maestri/musicisti/artista[@nome='Giacomo Puccini']/opera[2]" /> </td>
               </tr>
               <tr > 
                    <td> -------------------------------------- </td>
                    <td> -------------------------------------- </td>
          ...
          <tr > <td> <xsl:text> Query 4: estrae la prima opera di Michelangelo </xsl:text> </td>
          <td > <xsl:value-of select = "/maestri/pittori/artista[@nome='Michelangelo']/opera[4]" /></td></tr> 
